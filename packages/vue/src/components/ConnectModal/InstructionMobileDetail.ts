...
export const createInstructionMobileDetailProps = {
    connectWallet: {
...
export const InstructionMobileDetail = defineComponent({
    props: createInstructionMobileDetailProps,
    setup(props) {
        const { t } = useLocale();
        return ()=>{
            return h(Container,{
                ...
                h(Container,{
                    ...
                    props.wallet?.qrCode?.instructions?.steps.map((e)=>{
                        return h(Container,{
                            alignItems: 'center',
                            display:'flex',
                            flexDirection: 'row',
                ...
                h(Container,{
                    ...
                    h(Container,{
                        ...
                        display: 'block',
                        href: props.wallet?.qrCode?.instructions?.learnMoreUrl,
                        paddingX: '12',
                        paddingY: '4',
                        rel: 'noreferrer',
