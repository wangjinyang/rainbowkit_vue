import type { AccentColorPreset, AccentColor, ThemeOptions } from '../../types'
...
export function getMidnightTheme({
  accentColor = defaultAccentColor.accentColor,
  accentColorForeground = defaultAccentColor.accentColorForeground,
  ...baseThemeOptions
}: ThemeOptions = {}): ThemeVariables {
  return {
    ...getBaseTheme(baseThemeOptions),
    colors: {
      accentColor,
