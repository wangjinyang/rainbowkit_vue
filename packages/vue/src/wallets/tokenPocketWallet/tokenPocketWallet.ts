...
import type { DefaultWalletOptions, Wallet } from '@/types/composables/wallet';
import {
...
export const tokenPocketWallet = ({
  ...
  return {
    ...
    iconUrl: (import.meta.glob<{ default: string }>('./tokenPocketWallet.svg',{ query: '?url',eager: true }))['./tokenPocketWallet.svg'].default,
