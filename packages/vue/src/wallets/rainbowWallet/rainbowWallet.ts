import { isAndroid,isIOS, hasInjectedProvider,getWalletConnectConnector,getInjectedConnector } from '@/utils';
import type { DefaultWalletOptions, Wallet } from '@/types';
...
export const rainbowWallet = ({
  ...
  return {
    ...
    name: 'Rainbow',
    rdns: 'me.rainbow',
    iconUrl:  (import.meta.glob<{ default: string }>('./rainbowWallet.svg',{ query: '?url',eager: true }))['./rainbowWallet.svg'].default,
