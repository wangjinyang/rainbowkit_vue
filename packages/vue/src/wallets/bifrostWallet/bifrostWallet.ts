...
import { getWalletConnectConnector, getInjectedConnector, hasInjectedProvider } from '@/utils/wallet';
...
export const bifrostWallet = ({
  ...
  return {
    id: 'bifrostWallet',
    name: 'Bifrost Wallet',
    iconUrl: (import.meta.glob<{ default: string }>('./bifrostWallet.svg',{ query: '?url',eager: true }))['./bifrostWallet.svg'].default,
    iconBackground: '#fff',
